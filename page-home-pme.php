...
<?php if ( have_rows('cta') ) : ?>
  <?php while ( have_rows('cta') ) : the_row(); 
    ...
    $subtitulo     = get_sub_field('subtitulo_cta');
    $titulo        = get_sub_field('titulo_cta');
    $desc          = get_sub_field('descricao_cta');
    $titulo_botao  = get_sub_field('titulo_botao'); // novo campo
    ...
    $link_url    = '#';
    $link_label  = $titulo_botao ?: 'Monte seu pacote'; // usa o campo 'titulo_botao' se existir
    $link_target = '_self';

    if (is_array($link)) {
      $link_url    = !empty($link['url'])    ? $link['url']    : '#';
      $link_label  = !empty($link['title'])  ? $link['title']  : $link_label;
          ...
          <div class="col-12 col-lg-5 d-flex">
            <div class="nao-decidiu-content p-4 p-lg-5 my-auto">
              ...
              <?php if (!empty($subtitulo)) : ?>
                <small class="subtitle-cta fw-semibold text-success d-inline-block ls-1">
